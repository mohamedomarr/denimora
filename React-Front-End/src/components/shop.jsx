    ...
    if (selectedProduct && selectedSize) {
      try {
        ...
        if (availableSizes.length > 0) {
          const sizeObject = availableSizes.find(
            (s) => s.size && s.size.name === selectedSize
          );
          if (sizeObject) {
        ...
        await apiService.addToCart(selectedProduct.id, 1, false);
        ...
        <div className="Shop-section-title">
          ...
          {isUsingFallbackData && (
            <p className="fallback-notice">
              Note: Using local product data. Connect to backend for live
              products.
            </p>
          )}
        </div>
      ...
      {showAddCartPopup && selectedProduct && (
        <div className="popup-overlay" onClick={handleCloseAddCartPopup}>
          <div className="popup-content" onClick={(e) => e.stopPropagation()}>
            <span className="close-btn" onClick={handleCloseAddCartPopup}>
              &times;
            </span>
            ...
            <button
              ...
              disabled={
                !selectedSize || isLoadingSizes || availableSizes.length === 0
              }
            >
              Add to Cart
            </button>
